...
class PyDask(PythonPackage):
    ...
    version(
        "2021.6.2",
        sha256="8588fcd1a42224b7cfcd2ebc8ad616734abb6b1a4517efd52d89c7dd66eb91f8",
    )
    version(
        "2021.4.1",
    ...
    version(
        "2020.12.0",
        sha256="43e745afd4b464e6c0113131e430a16dce6ac42460b06e24d799093d098f7ab0",
    )
    version(
        "2.16.0",
    ...
    variant(
        "distributed",
        default=True,
        description="Install requirements for dask.distributed",
    )
    variant(
        "diagnostics",
        default=False,
        description="Install requirements for dask.diagnostics",
    )
    variant(
        "delayed",
        default=True,
    ...
    depends_on(
        "py-distributed@2020.12.0:",
        type=("build", "run"),
        when="@2020.12.0: +distributed",
    )
    depends_on(
        "py-distributed@2021.6.2:",
        type=("build", "run"),
        when="@2021.6.2: +distributed",
    )
