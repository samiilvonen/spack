...
class Gsl(AutotoolsPackage, GNUMirrorPackage):
    ...
    version(
        "2.6", sha256="b782339fc7a38fe17689cb39966c4d821236c28018b6593ddb6fd59ee40786a8"
    )
    version(
        "2.5", sha256="0460ad7c2542caaddc6729762952d345374784100223995eb14d614861f2258d"
    )
    version(
        "2.4", sha256="4d46d07b946e7b31c19bbf33dda6204d7bedc2f5462a1bae1d4013426cd1ce9b"
    )
    version(
        "2.3", sha256="562500b789cd599b3a4f88547a7a3280538ab2ff4939504c8b4ac4ca25feadfb"
    )
    version(
        "2.2.1",
    ...
    version(
        "2.1", sha256="59ad06837397617f698975c494fe7b2b698739a59e2fcf830b776428938a0c66"
    )
    version(
        "2.0", sha256="e361f0b19199b5e6c21922e9f16adf7eca8dd860842802424906d0f83485ca2d"
    )
    version(
        "1.16",
    ...
    def configure_args(self):
        ...
        if self.spec.satisfies("+external-cblas"):
            ...
            configure_args.append(
                "CBLAS_CFLAGS=%s" % self.spec["blas"].headers.include_flags
            )
