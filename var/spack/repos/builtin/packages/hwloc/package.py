...
class Hwloc(AutotoolsPackage):
    ...
    version(
        "2.6.0",
        sha256="9aa7e768ed4fd429f488466a311ef2191054ea96ea1a68657bc06ffbb745e59f",
    )
    version(
        "2.5.0",
        sha256="38aa8102faec302791f6b4f0d23960a3ffa25af3af6af006c64dbecac23f852c",
    )
    version(
        "2.4.1",
    ...
    version(
        "2.3.0",
        sha256="155480620c98b43ddf9ca66a6c318b363ca24acb5ff0683af9d25d9324f59836",
    )
    version(
        "2.2.0",
    ...
    version(
        "2.0.4",
        sha256="efadca880f5a59c6d5d6f7bc354546aa6f780d77cc2e139634c3de9564e7ce1f",
    )
    version(
        "2.0.3",
    ...
    version(
        "2.0.2",
        sha256="27dcfe42e3fb3422b72ce48b48bf601c0a3e46e850ee72d9bdd17b5863b6e42c",
    )
    version(
        "2.0.1",
        sha256="f1156df22fc2365a31a3dc5f752c53aad49e34a5e22d75ed231cd97eaa437f9d",
    )
    version(
        "2.0.0",
        sha256="a0d425a0fc7c7e3f2c92a272ffaffbd913005556b4443e1887d2e1718d902887",
    )
    version(
        "1.11.13",
        sha256="a8f781ae4d347708a07d95e7549039887f151ed7f92263238527dfb0a3709b9d",
    )
    version(
        "1.11.12",
        sha256="f1d49433e605dd653a77e1478a78cee095787d554a94afe40d1376bca6708ca5",
    )
    version(
        "1.11.11",
        sha256="74329da3be1b25de8e98a712adb28b14e561889244bf3a8138afe91ab18e0b3a",
    )
    version(
        "1.11.10",
        sha256="0a2530b739d9ebf60c4c1e86adb5451a20d9e78f7798cf78d0147cc6df328aac",
    )
    version(
        "1.11.9",
        sha256="85b978995b67db0b1a12dd1a73b09ef3d39f8e3cb09f8b9c60cf04633acce46c",
    )
    version(
        "1.11.8",
    ...
    version(
        "1.11.7",
        sha256="ac16bed9cdd3c63bca1fe1ac3de522a1376b1487c4fc85b7b19592e28fd98e26",
    )
    version(
        "1.11.6",
        sha256="67963f15197e6b551539c4ed95a4f8882be9a16cf336300902004361cf89bdee",
    )
    version(
        "1.11.5",
    ...
    version(
        "1.11.3",
        sha256="03a1cc63f23fed7e17e4d4369a75dc77d5c145111b8578b70e0964a12712dea0",
    )
    version(
        "1.11.2",
