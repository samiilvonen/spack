...
class SpiralPackageHcol(Package):
    ...
    url = (
        "https://github.com/spiral-software/spiral-package-hcol/archive/refs/tags/1.0.0.tar.gz"
    )
    ...
    version(
        "1.0.0",
        sha256="18ae6f0a090de03723612a6c91ca17cf62971129540936d8c2738bd8f807a511",
    )
