...
class Clhep(CMakePackage):
    ...
    version(
        "2.3.4.6",
        sha256="3e53947036f8570c7a08bed670a862426dbca17328afcecd6c875d8487fef204",
    )
    version(
        "2.3.4.5",
    ...
    version(
        "2.3.4.2",
        sha256="6d1e15ccbe1ca6e71d541e78ca7e8c9f3d986ee0da5177a4b8cda00c619dc691",
    )
    version(
        "2.3.3.2",
    ...
    version(
        "2.3.3.0",
        sha256="0bcae1bed8d3aa4256e3a553a4f60484312f2121dcc83492a40f08a70881c8c0",
    )
    version(
        "2.3.2.2",
    ...
    version(
        "2.3.0.0",
        sha256="63e77f4f34baa5eaa0adb1ca2438734f2d6f5ca112d830650dd005a6109f2397",
    )
    version(
        "2.2.0.8",
        sha256="f735e236b1f023ba7399269733b2e84eaed4de615081555b1ab3af25a1e92112",
    )
    version(
        "2.2.0.5",
        sha256="92e8b5d32ae96154edd27d0c641ba048ad33cb69dd4f1cfb72fc578770a34818",
    )
    version(
        "2.2.0.4",
    ...
    def cmake_args(self):
        cmake_args = ["-DCLHEP_BUILD_CXXSTD=-std=c++{0}".format(self.spec.variants["cxxstd"].value)]
        return cmake_args
