...
class AutodockVina(MakefilePackage):
    ...
    version(
        "1.2.1",
        sha256="2d8d9871a5a95265c03c621c0584d9f06b202303116e6c87e23c935f7b694f74",
    )
    version(
        "1.2.0",
        sha256="9c9a85766b4d124d7c1d92e767aa8b4580c6175836b8aa2c28f88a9c40a5b90e",
    )
    version(
        "1.1.2",
    ...
    depends_on(
        "boost@1.54.0: +filesystem +program_options +serialization +system +thread",
        when="@1.2.0:",
    )
    ...
    def edit(self, spec, prefix):
        with working_dir(self.build_directory):
            ...
            makefile.filter(
                "BOOST_INCLUDE = .*",
                "BOOST_INCLUDE = %s" % self.spec["boost"].prefix.include,
            )
