...
class Gptune(CMakePackage):
    ...
    version(
        "3.0.0",
        sha256="e19bfc3033fff11ff8c20cae65b88b7ca005d2c4e4db047f9f23226126ec92fa",
    )
    version(
        "2.1.0",
        sha256="737e0a1d83f66531098beafa73dd479f12def576be83b1c7b8ea5f1615d60a53",
    )
    ...
    def test(self):
        ...
        if "+hypre" in spec:
            ...
            self.run_test(
                "git",
                options=["clone", "https://github.com/hypre-space/hypre.git"],
                work_dir=wd,
            )
