...
class PyPyutilib(PythonPackage):
    ...
    version(
        "6.0.0",
        sha256="b758419b42f9f512330644ebf05d54a1d3c5671268c344204e02f32713342de5",
    )
    version(
        "5.6.2",
        sha256="3f9f500cf1f15a92e7eb0b3c3ca2af537a2a9e61fe70ad6be4d2d08d9e47764f",
    )
    version(
        "5.6.1",
    ...
    version(
        "5.3.4",
        sha256="475c97bf1213add6b7fefaa3f05affef3613e6aecc9fcb3cc0693304671b73c3",
    )
    version(
        "5.3.3",
        sha256="318f4d60c9552493fe81a4b2e0418d2cf43aaab68e6d23e2c9a68ef010c9cf21",
    )
