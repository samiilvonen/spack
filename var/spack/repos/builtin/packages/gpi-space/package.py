...
class GpiSpace(CMakePackage):
    ...
    version(
        "22.03",
        sha256="b01500b9480452aee865a0ef98cf40864f847b7e22ea572f9a6f0f5ac2ae9a1a",
    )
    version(
        "21.12.1",
    ...
    depends_on(
        "boost@1.62.0:1.63.0 +atomic +chrono +coroutine +context +date_time +filesystem +iostreams +program_options +random +regex +serialization +test +timer cxxstd=14"
    )
