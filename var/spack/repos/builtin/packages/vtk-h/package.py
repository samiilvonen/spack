...
class VtkH(Package, CudaPackage):
    ...
    version(
        "0.8.1",
        sha256="0cb1c84087e2b9385477fba3e7e197d6eabe1d366bd3bc87d7824e50dcdbe057",
    )
    version(
        "0.8.0",
        sha256="8366ebfe094c258555f343ba1f9bbad1d8e4804f844768b639f6ff13a6390f29",
    )
    version(
        "0.7.1",
    ...
    for _arch in CudaPackage.cuda_arch_values:
        depends_on(
            "vtk-m cuda_arch={0}".format(_arch),
