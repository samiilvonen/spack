...
class Julia(MakefilePackage):
    ...
    version(
        "1.6.5",
        sha256="b70ae299ff6b63a9e9cbf697147a48a31b4639476d1947cb52e4201e444f23cb",
    )
    version(
        "1.6.4",
    ...
    depends_on(
        "llvm targets=amdgpu,bpf,nvptx,webassembly version_suffix=jl +link_llvm_dylib ~internal_unwind"
    )
    depends_on("libuv")
