...
class Octave(AutotoolsPackage, GNUMirrorPackage):
    ...
    version(
        "6.3.0",
        sha256="232065f3a72fc3013fe9f17f429a3df69d672c1f6b6077029a31c8f3cd58a66e",
    )
    version(
        "6.2.0",
    ...
    version(
        "5.1.0",
        sha256="e36b1124cac27c7caa51cc57de408c31676d5f0096349b4d50b57bfe1bcd7495",
    )
    version(
        "4.4.1",
        sha256="09fbd0f212f4ef21e53f1d9c41cf30ce3d7f9450fb44911601e21ed64c67ae97",
    )
    version(
        "4.4.0",
    ...
    version(
        "4.2.0",
        sha256="443ba73782f3531c94bcf016f2f0362a58e186ddb8269af7dcce973562795567",
    )
    version(
        "4.0.2",
