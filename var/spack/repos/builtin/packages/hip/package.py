...
class Hip(CMakePackage):
    ...
    patch(
        "0010-Improve-compilation-without-git-repo-and-remove-compiler-rt-linkage-for-host.5.0.0.patch",
        when="@5.0.0",
    )
    patch(
        "0011-Improve-compilation-without-git-repo-and-remove-compiler-rt-linkage-for-host.5.0.2.patch",
        when="@5.0.2:",
    )
