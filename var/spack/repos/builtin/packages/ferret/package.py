...
class Ferret(Package):
    ...
    version(
        "7.6.0",
        sha256="69832d740bd44c9eadd198a5de4d96c4c01ae90ae28c2c3414c1bb9f43e475d1",
    )
    version(
        "7.5.0",
    ...
    def setup_run_environment(self, env):
        ...
        env.set(
            "FER_GO",
            " ".join([".", self.prefix.go, self.prefix.examples, self.prefix.contrib]),
        )
