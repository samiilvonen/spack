...
class PyBotocore(PythonPackage):
    ...
    version(
        "1.12.169",
        sha256="25b44c3253b5ed1c9093efb57ffca440c5099a2d62fa793e8b6c52e72f54b01e",
    )
    ...
    depends_on(
        ...
        type=("build", "run"),
        when="@1.14.12:1.18 ^python@3.4.0:3.4",
    )
    depends_on("py-urllib3@1.20:1.25", type=("build", "run"), when="@1.14.12:1.18")
    depends_on(
        "py-urllib3@1.25.4:1.25.7",
        type=("build", "run"),
        when="@1.19.0: ^python@3.4.0:3.4",
    )
