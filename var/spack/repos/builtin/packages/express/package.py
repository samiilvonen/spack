...
class Express(CMakePackage):
    ...
    version(
        "1.5.3",
        sha256="dfea819bbe7187a06462d6549a13f9cad7f3f128cb5c62bd90946f972c45a1f2",
    )
    version(
        "1.5.2",
    ...
    depends_on(
        "boost+date_time+exception+filesystem+system+chrono+atomic+container+math+thread+program_options"
    )
    depends_on("bamtools")
    depends_on("zlib")
