...
class Openmpi(AutotoolsPackage, CudaPackage):
    ...
    version(
        "4.0.6",
        sha256="94b7b59ae9860f3bd7b5f378a698713e7b957070fdff2c43453b6cbf8edb410c",
    )  # libmpi.so.40.20.6
    version(
        "4.0.5",
    ...
    version(
        "3.1.6",
        sha256="50131d982ec2a516564d74d5616383178361c2f08fdd7d1202b80bdf66a0d279",
    )  # libmpi.so.40.10.4
    version(
        "3.1.5",
        sha256="fbf0075b4579685eec8d56d34d4d9c963e6667825548554f5bf308610af72133",
    )  # libmpi.so.40.10.4
    version(
        "3.1.4",
    ...
    version(
        "3.0.5",
        sha256="f8976b95f305efc435aa70f906b82d50e335e34cffdbf5d78118a507b1c6efe8",
    )  # libmpi.so.40.00.5
    version(
        "3.0.4",
        sha256="2ff4db1d3e1860785295ab95b03a2c0f23420cda7c1ae845c419401508a3c7b5",
    )  # libmpi.so.40.00.5
    version(
        "3.0.3",
        sha256="fb228e42893fe6a912841a94cd8a0c06c517701ae505b73072409218a12cf066",
    )  # libmpi.so.40.00.4
    version(
        "3.0.2",
        sha256="d2eea2af48c1076c53cabac0a1f12272d7470729c4e1cb8b9c2ccd1985b2fb06",
    )  # libmpi.so.40.00.2
    version(
        "3.0.1",
    ...
    version(
        "2.1.6",
        sha256="98b8e1b8597bbec586a0da79fcd54a405388190247aa04d48e8c40944d4ca86e",
    )  # libmpi.so.20.10.3
    version(
        "2.1.5",
        sha256="b807ccab801f27c3159a5edf29051cd3331d3792648919f9c4cee48e987e7794",
    )  # libmpi.so.20.10.3
    version(
        "2.1.4",
        sha256="3e03695ca8bd663bc2d89eda343c92bb3d4fc79126b178f5ddcb68a8796b24e2",
    )  # libmpi.so.20.10.3
    version(
        "2.1.3",
        sha256="285b3e2a69ed670415524474496043ecc61498f2c63feb48575f8469354d79e8",
    )  # libmpi.so.20.10.2
    version(
        "2.1.2",
    ...
    version(
        "2.0.4",
        sha256="4f82d5f7f294becbd737319f74801206b08378188a95b70abe706fdc77a0c20b",
    )  # libmpi.so.20.0.4
    version(
        "2.0.3",
        sha256="b52c0204c0e5954c9c57d383bb22b4181c09934f97783292927394d29f2a808a",
    )  # libmpi.so.20.0.3
    version(
        "2.0.2",
    ...
    version(
        "1.10.7",
        sha256="a089ece151fec974905caa35b0a59039b227bdea4e7933069e94bee4ed0e5a90",
    )  # libmpi.so.12.0.7
    version(
        "1.10.6",
        sha256="65606184a084a0eda6102b01e5a36a8f02d3195d15e91eabbb63e898bd110354",
    )  # libmpi.so.12.0.6
    version(
        "1.10.5",
        sha256="a95fa355ed3a905c7c187bc452529a9578e2d6bae2559d8197544ab4227b759e",
    )  # libmpi.so.12.0.5
    version(
        "1.10.4",
        sha256="fb3c0c4c77896185013b6091b306d29ba592eb40d8395533da5c8bc300d922db",
    )  # libmpi.so.12.0.4
    version(
        "1.10.3",
    ...
    version(
        "1.8.7",
        sha256="da629e9bd820a379cfafe15f842ee9b628d7451856085ccc23ee75ab3e1b48c7",
    )  # libmpi.so.1.6.2
    version(
        "1.8.6",
    ...
    version(
        "1.8.3",
        sha256="2ef02dab61febeb74714ff80d508c00b05defc635b391ed2c8dcc1791fbc88b3",
    )  # libmpi.so.1.6.0
    version(
        "1.8.2",
        sha256="ab70770faf1bac15ef44301fe2186b02f857646545492dd7331404e364a7d131",
    )  # libmpi.so.1.5.2
    version(
        "1.8.1",
        sha256="171427ebc007943265f33265ec32e15e786763952e2bfa2eac95e3e192c1e18f",
    )  # libmpi.so.1.5.0
    version(
    ...
    version(
        "1.7.4",
        sha256="ff8e31046c5bacfc6202d67f2479731ccd8542cdd628583ae75874000975f45c",
    )  # libmpi.so.1.3.0
    version(
        "1.7.3",
    ...
    version(
        "1.6.2",
        sha256="5cc7744c6cc4ec2c04bc76c8b12717c4011822a2bd7236f2ea511f09579a714a",
    )  # libmpi.so.1.0.3
    version(
        "1.6.1",
        sha256="077240dd1ab10f0caf26931e585db73848e9815c7119b993f91d269da5901e3a",
    )  # libmpi.so.1.0.3
    version(
    ...
    version(
        "1.5.5",
        sha256="660e6e49315185f88a87b6eae3d292b81774eab7b29a9b058b10eb35d892ff23",
    )  # libmpi.so.1.0.3
    version(
        "1.5.4",
        sha256="81126a95a51b8af4bb0ad28790f852c30d22d989713ec30ad22e9e0a79587ef6",
    )  # libmpi.so.1.0.2
    version(
        "1.5.3",
        sha256="70745806cdbe9b945d47d9fa058f99e072328e41e40c0ced6dd75220885c5263",
    )  # libmpi.so.1.0.1
    version(
        "1.5.2",
        sha256="7123b781a9fd21cc79870e7fe01e9c0d3f36935c444922661e24af523b116ab1",
    )  # libmpi.so.1.0.1
    version(
        "1.5.1",
        sha256="c28bb0bd367ceeec08f739d815988fca54fc4818762e6abcaa6cfedd6fd52274",
    )  # libmpi.so.1.0.0
    version(
    ...
    version(
        "1.4.5",
        sha256="a3857bc69b7d5258cf7fc1ed1581d9ac69110f5c17976b949cb7ec789aae462d",
    )  # libmpi.so.0.0.4
    version(
        "1.4.4",
        sha256="9ad125304a89232d5b04da251f463fdbd8dcd997450084ba4227e7f7a095c3ed",
    )  # libmpi.so.0.0.3
    version(
        "1.4.3",
        sha256="220b72b1c7ee35469ff74b4cfdbec457158ac6894635143a33e9178aa3981015",
    )  # libmpi.so.0.0.2
    version(
        "1.4.2",
        sha256="19129e3d51860ad0a7497ede11563908ba99c76b3a51a4d0b8801f7e2db6cd80",
    )  # libmpi.so.0.0.2
    version(
        "1.4.1",
    ...
    version(
        "1.3.4",
        sha256="fbfe4b99b0c98f81a4d871d02f874f84ea66efcbb098f6ad84ebd19353b681fc",
    )  # libmpi.so.0.0.1
    version(
        "1.3.3",
        sha256="e1425853282da9237f5b41330207e54da1dc803a2e19a93dacc3eca1d083e422",
    )  # libmpi.so.0.0.0
    version(
        "1.3.2",
        sha256="c93ed90962d879a2923bed17171ed9217036ee1279ffab0925ea7eead26105d8",
    )  # libmpi.so.0.0.0
    version(
        "1.3.1",
    ...
    version(
        "1.2.9",
        sha256="0eb36abe09ba7bf6f7a70255974e5d0a273f7f32d0e23419862c6dcc986f1dff",
    )  # libmpi.so.0.0.0
    version(
        "1.2.8",
        sha256="75b286cb3b1bf6528a7e64ee019369e0601b8acb5c3c167a987f755d1e41c95c",
    )  # libmpi.so.0.0.0
    version(
        "1.2.7",
        sha256="d66c7f0bb11494023451651d0e61afaef9d2199ed9a91ed08f0dedeb51541c36",
    )  # libmpi.so.0.0.0
    version(
        "1.2.6",
        sha256="e5b27af5a153a257b1562a97bbf7164629161033934558cefd8e1e644a9f73d3",
    )  # libmpi.so.0.0.0
    version(
        "1.2.5",
        sha256="3c3aed872c17165131c77bd7a12fe8aec776cb23da946b7d12840db93ab79322",
    )  # libmpi.so.0.0.0
    version(
        "1.2.4",
        sha256="594a3a0af69cc7895e0d8f9add776a44bf9ed389794323d0b1b45e181a97e538",
    )  # libmpi.so.0.0.0
    version(
        "1.2.3",
        sha256="f936ca3a197e5b2d1a233b7d546adf07898127683b03c4b37cf31ae22a6f69bb",
    )  # libmpi.so.0.0.0
    version(
        "1.2.2",
        sha256="aa763e0e6a6f5fdff8f9d3fc988a4ba0ed902132d292c85aef392cc65bb524e6",
    )  # libmpi.so.0.0.0
    version(
        "1.2.1",
        sha256="a94731d84fb998df33960e0b57ea5661d35e7c7cd9d03d900f0b6a5a72e4546c",
    )  # libmpi.so.0.0.0
    version(
    ...
    version(
        "1.1.5",
        sha256="913deaedf3498bd5d06299238ec4d048eb7af9c3afd8e32c12f4257c8b698a91",
    )  # libmpi.so.0.0.0
    version(
        "1.1.4",
        sha256="21c37f85df7e959f17cc7cb5571d8db2a94ed2763e3e96e5d052aff2725c1d18",
    )  # libmpi.so.0.0.0
    version(
        "1.1.3",
        sha256="c33f8f5e65cfe872173616cca27ae8dc6d93ea66e0708118b9229128aecc174f",
    )  # libmpi.so.0.0.0
    version(
        "1.1.2",
        sha256="3bd8d9fe40b356be7f9c3d336013d3865f8ca6a79b3c6e7ef28784f6c3a2b8e6",
    )  # libmpi.so.0.0.0
    version(
        "1.1.1",
        sha256="dc31aaec986c4ce436dbf31e73275ed1a9391432dcad7609de8d0d3a78d2c700",
    )  # libmpi.so.0.0.0
    version(
    ...
    version(
        "1.0.2",
        sha256="ccd1074d7dd9566b73812d9882c84e446a8f4c77b6f471d386d3e3b9467767b8",
    )  # libmpi.so.0.0.0
    version(
        "1.0.1",
        sha256="f801b7c8ea6c485ac0709a628a479aeafa718a205ed6bc0cf2c684bc0cc73253",
    )  # libmpi.so.0.0.0
    version(
    ...
    def filter_rpaths(self):
        def filter_lang_rpaths(lang_tokens, rpath_arg):
            ...
            files.extend(
                find(
                    self.spec.prefix.lib.pkgconfig,
...
def get_spack_compiler_spec(path):
    ...
    for spack_compiler in spack_compilers:
        if spack_compiler.cc and os.path.dirname(spack_compiler.cc) == path:
